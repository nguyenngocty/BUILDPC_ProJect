...
function useClientProductDetail() {
  ...
  const loadProduct = useCallback(async () => {
    ...
    try {
      ...
      /*
       * Nếu API Detail chưa trả reviews
       * thì fallback sang API comments.
       */
      ...
      /*
       * Fallback nếu BE không trả defaultVariant.
       */
      if (!defaultVariant) {
        defaultVariant =
      ...
      // HAS VARIANTS
      //
      // Ưu tiên field Backend.
      //
      // Một Product chỉ có 1 default variant kỹ thuật
      // sẽ KHÔNG hiển thị selector.
      // ======================================================
      ...
      console.error("Load product detail:", error);
