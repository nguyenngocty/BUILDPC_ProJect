    ...
    <section className="bp-featured">
      <div className="bp-featured__header">
        <div>
          ...
          <p>Những nội dung được BuildPC lựa chọn dành cho bạn.</p>
        </div>
      </div>
      ...
      <div className="bp-featured__layout">
        ...
        <Link to={`/blog/${mainPost.id}`} className="bp-featured__main">
          ...
          <div className="bp-featured__overlay">
            <span className="bp-featured__category">{mainPost.category}</span>
          ...
          <div className="bp-featured__sidebar">
            {sidePosts.map((item) => (
              ...
              >
                ...
                <div className="bp-featured__overlay">
                  <span className="bp-featured__category">{item.category}</span>
