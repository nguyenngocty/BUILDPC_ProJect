...
function normalizeRangeDays(value) {
  ...
  return ALLOWED_RANGE_DAYS.includes(rangeDays)
    ? rangeDays
    : 7;
}
...
async function getDashboardSummary(
  ...
  const [
     ...
     *
     * Điểm quan trọng:
     * Không sort theo created_at nữa.
     *
     * Sort theo updated_at trước.
     * Khi admin đổi trạng thái:
     *
     * updated_at = NOW()
     *
     * => đơn đó sẽ nhảy lên đầu.
     */
    pool.query(
      `
        SELECT
